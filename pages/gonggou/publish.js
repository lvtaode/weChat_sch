...
Page({
  ...
  formSubmit:function(e){
    ...
    result.user_id=this.data.userId;
    result.picUrl=this.data.imgUrl;
    // console.log(result); 
    var that=this;
    if (result.title == "" || result.kind == "" || result.contacts=="" || result.tel=="" || result.details==""){
      wx.showToast({
        title: '信息不完善',
      ...
      wx.request({
        url: 'https://www.chinascw.net/xcx/post/fabu',
        header: {
        ...
        success: function (res) {
          ...
          setTimeout(function(){
            wx.switchTab({
              url: '/pages/gonggou/gonggou?userId='+that.data.userId,
            })
          },1500)     
        }
      })
